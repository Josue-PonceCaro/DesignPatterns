...
if __name__ == '__main__':
    ...
    p11 = Point(2, 3, CoordinateSystem.POLAR)
    p2 = PointFactory.new_cartesian_point(1, 2)
    p3 = PointFactory.new_polar_point(1, 2)
    p33 = p3.new_polar_point(1,2)
    p333 = p33.new_polar_point(1,2)
    print(p33)
    print(p333)
    # or you can expose factory through the type
    p4 = Point.Factory.new_cartesian_point(5, 6)
    p5 = Point.factory.new_cartesian_point(7, 8)
    print(p1,p11, p2,p3)
    print(p4,p5)
